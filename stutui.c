...
const char *config_header = "# stutui config file\n"
                            "\n"
...
void init_log_path() {
  ...
  snprintf(lock_filepath, sizeof(lock_filepath), "/tmp/stutui-%d.lock",
           getuid());
  snprintf(config_filepath, sizeof(config_filepath), "%s/stutui.conf",
           config_dir);
